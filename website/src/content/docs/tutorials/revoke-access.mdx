...
For the full runbook covering scope inventory, batch revoke, source rotation, error handling, and the append-only caveats, see [Offboard a Departing Team Member](/runbooks/team-member-offboarding/).
