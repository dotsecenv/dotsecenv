...
- Point the Codex maintainer skills under `.agents/skills/` at their real script paths so `changelog` and `cli-reference-drift` resolve, and symlink the scripts to their `.claude/skills/` originals (#344)
