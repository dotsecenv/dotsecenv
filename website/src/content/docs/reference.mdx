...
Inspect and validate the system-wide policy directory at `/etc/dotsecenv/policy.d/`. See [Policy Directory](/concepts/policy-directory/) for the full design.
...
- [Policy Directory](/concepts/policy-directory/): admin-pinned organization-wide rules
