      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Org-wide Keypair in CI', slug: 'tutorials/org-wide-keypair' },
            { label: 'Share a Secret', slug: 'tutorials/share-secret' },
            { label: 'Revoke Access', slug: 'tutorials/revoke-access' },
            { label: 'Apply a Security Policy', slug: 'tutorials/apply-a-policy' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Key Scope', slug: 'concepts/key-scope' },
