...
```bash
bash .agents/skills/changelog/assess.sh
```
...
1. Run `bash .agents/skills/changelog/assess.sh` and add any missing entries.
...
Then proceed with the tag per [AGENTS.md](../../AGENTS.md) "Release new version".
The optional Twitter/X announcement guidance lives in
[website/AGENTS.md](../../website/AGENTS.md) "Changelog Generation".
