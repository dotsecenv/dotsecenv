...
`, vaultPath)
	...
	_, _, _ = runCmdWithEnv(envA, "-c", configPath, "vault", "identity", "add", fpA)
	_, _, _ = runCmdWithEnv(envA, "-c", configPath, "vault", "identity", "add", fpB)
...
`, vaultPath)
	...
	_, _, _ = runCmdWithEnv(envA, "-c", configPath, "vault", "identity", "add", fpA)
	_, _, _ = runCmdWithEnv(envA, "-c", configPath, "vault", "identity", "add", fpB)
	_, _, _ = runCmdWithEnv(envA, "-c", configPath, "vault", "identity", "add", fpC)
